...
export default function Footer() {
  return (
    <footer id="contact" className="relative">
      ...
      <div className="relative px-6 py-32 max-w-5xl mx-auto">
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {socials.map(({ icon: Icon, href, label }, i) => (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-md border border-white/5 bg-white/[0.02] text-neutral-400 transition-all duration-300 group-hover:text-white group-hover:border-accent/40 group-hover:-translate-y-1">
                  <Icon />
                </div>
